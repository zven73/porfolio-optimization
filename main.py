...
def generate_optimum_portfolio():
    ...
    cp.plot_prices_log(closing_prices)
    ...
    fr.save_to_file_transposed(portfolios_allocations_df, 'MonteCarloPortfolios')
    ...
    #save data
    print('7. Saving Data')
    fr.save_to_file_transposed(portfolios_allocations_df, 'OptimisationPortfolios')
